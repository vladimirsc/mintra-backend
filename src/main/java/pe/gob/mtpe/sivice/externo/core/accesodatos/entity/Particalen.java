...
public class Particalen implements Serializable {
	...
	@Column(name = "CALENDARIO_FK")
	private Long cAlendariofk;
	...
	public Long getcAlendariofk() {
		return cAlendariofk;
	}

	public void setcAlendariofk(Long cAlendariofk) {
		this.cAlendariofk = cAlendariofk;
	}
