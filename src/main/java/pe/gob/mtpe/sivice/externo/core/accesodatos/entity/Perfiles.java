...
public class Perfiles implements Serializable {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE,generator="SEQ_TBX_PERFILES") 
	@SequenceGenerator(name="SEQ_TBX_PERFILES",sequenceName="DB_TRAMITE.SEQ_TBX_PERFILES", allocationSize=1) 
	@Column(name = "PERFIL_ID_PK")
	private Long pErfilidpk;
	...
	public Long getpErfilidpk() {
		return pErfilidpk;
	}

	public void setpErfilidpk(Long pErfilidpk) {
		this.pErfilidpk = pErfilidpk;
	}
